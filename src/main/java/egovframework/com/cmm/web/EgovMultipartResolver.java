			...
			if (fileItem.isFormField()) {
				...
				if (whiteListFileUploadExtensions == null || "".equals(whiteListFileUploadExtensions)) {
					...
					if (fileName == null || "".equals(fileName)) {
						...
						// 2024.08.29 whiteListFileUploadExtensions 및 blob 허용
						if ((whiteListFileUploadExtensions+".").contains("."+fileExtension.toLowerCase()+".") || ("blob".equals(fileExtension) & "$$param$$".equals(file.getName()))) {
