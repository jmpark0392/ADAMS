...
@Slf4j
@Component
public class AdamsJwtTokenUtil implements Serializable{
    ...
    public String generateToken(AdamsLoginDTO adamsLoginDTO) {
        return doGenerateToken(adamsLoginDTO, "Authorization");
    }
    ...
    private String doGenerateToken(AdamsLoginDTO adamsLoginDTO, String subject) {

        Map<String, Object> claims = new HashMap<>();
        claims.put("id", adamsLoginDTO.getUsrId() );
        claims.put("name", adamsLoginDTO.getUsrNm() );
        claims.put("userSe", adamsLoginDTO.getUsrDvCd() );
        //claims.put("orgnztId", adamsLoginDTO.getOrgnztId() );
        //claims.put("uniqId", adamsLoginDTO.getUniqId() );
